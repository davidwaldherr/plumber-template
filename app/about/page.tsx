...
export default function AboutPage() {
  ...
  return (
    <div className="container mx-auto px-4 lg:px-8 mt-12 mb-12">
      <h1 className="text-6xl font-bold text-center text-amber-500 mb-12">
        About Expert Plumbing
      </h1>
      
      <section className="mb-16">
        <h2 className="text-5xl font-semibold mb-8 text-amber-400">Our Story</h2>
      ...
      <section>
        <h2 className="text-5xl font-semibold mb-12 text-amber-400">Meet Our Team</h2>
          ...
          {teamMembers.map((member, index) => (
            <Card key={index} className="bg-slate-700">
              <Image
                ...
                src={member.image}
              />
              <CardBody className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                <h3 className="text-white font-bold text-3xl">{member.name}</h3>
